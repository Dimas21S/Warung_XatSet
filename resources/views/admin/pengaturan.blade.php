    ...
    <div class="sidebar flex flex-col justify-between" style="position: fixed; top:0; left:0; height:100vh;">
        <div>
            ...
            <nav class="mt-4">
                ...
                <a href="{{ route('admin.identitas') }}" class="sidebar-link active">Identitas</a>
                <a href="{{ route('admin.diskon') }}" class="sidebar-link">Diskon</a>
            </nav>
        </div>
    ...
    <div class="flex-1" style="margin-left: 220px;">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm">
                <form action="{{ route('admin.identitas.update') }}" method="POST">
                    @csrf
                    @method('PUT')
