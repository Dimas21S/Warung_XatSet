...
<body class="">
    ...
    <div class="px-4 py-4 bg-[rgba(9,125,76,1)]">
        ...
        <div class="flex gap-4 overflow-x-auto pb-2">
            ...
            <button class="flex flex-col items-center justify-center gap-2 text-white hover:text-black transition border border-white hover:border-black p-4 rounded-2xl shadow-md w=64" onclick="window.location.href='{{ route('produk') }}'"> 
                <!-- ICON --> 
