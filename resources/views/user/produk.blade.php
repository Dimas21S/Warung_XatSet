...
<body class="">
    ...
    <div class="pb-4">
        <h1 class="text-2xl font-bold text-black pt-6 pl-4">Masak Praktis Anti Ribet</h1>
    ...
    <div class="px-4 py-2 bg-[rgba(9,125,76,1)]">
        <h1 class="text-xl font-bold text-white pb-2">Produk Unggulan</h1>
        <!-- Grid Card Horizontal -->
        <div class="bg-[#E9E3D3] p-4 rounded-2xl shadow-md w-64">
            
            <!-- Gambar -->
            <img 
                src="{{ asset('image/makanan.jpg') }}" 
                class="w-full h-40 object-cover rounded-xl"
            >
            <!-- Nama Menu -->
            <h2 class="mt-3 text-lg font-semibold text-green-900">
            ...
            <!-- Tombol -->
            <button class="mt-4 w-full bg-yellow-600 hover:bg-yellow-700 text-white py-2 rounded-xl font-medium transition">
                + Keranjang
            </button>
        </div>
    </div>
